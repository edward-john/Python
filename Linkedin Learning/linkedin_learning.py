...
# USERNAME = 'John@ioca.co.nz'
# PASSWORD = 'WYF7!VShj703'
# COURSES = [slugs.rstrip('\n') for slugs in open('{}\\Desktop\\Slugs.txt'.format(os.environ['USERPROFILE']), 'r')]

# # EDIT IF YOU NEED TO
# BASE_DOWNLOAD_PATH = '{}\\Desktop\\Courses'.format(os.environ['USERPROFILE'])
# USE_PROXY = False
